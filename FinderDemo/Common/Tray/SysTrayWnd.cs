...
namespace FinderDemo.Common.Tray
{
    public class SysTrayWnd
    {
        public struct TrayItemData
        {
            ...
            public Win32.TRAYDATA trayData;
        }
            ...
            try
            {
                ...
                for (int i = 0; i < iTrayItemCount; i++)
                {
                    try
                    {
                        ...
                        iRet = Win32.ReadProcessMemory(hTrayProcess, (int)tbButtonInfo.dwData, hTrayData, Marshal.SizeOf(trayData), out iOut);
                        Marshal.PtrToStructure(hTrayData, trayData);

                        //Win32.PostMessage((IntPtr)66648, trayData.uCallbackMessage, (int)trayData.uID, 513);
                        //Win32.PostMessage((IntPtr)66648, trayData.uCallbackMessage, (int)trayData.uID, 514);
